...
switch (template) {
case 'codenhentai':
            let json = await fetch('https://wudysoft.up.railway.app/api/anime/codenhentai?code=' + one + '&apikey=Lann')
	...
	return conn.sendListM(m.chat, aan_, aa_, m)
            ...
            case 'neko':
            case 'waifu':
        let bb = 'https://wudysoft.up.railway.app/api/anime/' + args[0] + '?apikey=Lann'
...
conn.sendButton(m.chat, bbi, author, bb, [['Menu', '/menu']], m, adReply)
  ...
  if (/webp/g.test(b__d)) d__d = await webp2png(c__d)
        ...
        let cc = 'https://wudysoft.up.railway.app/api/convert/' + args[0] + '?url=' + d__d + '&apikey=Lann'
...
case 'warface':
case 'water':
        let dd = 'https://wudysoft.up.railway.app/api/ephoto/' + args[0] + '?text=' + one + '&apikey=Lann'
...
let a__c = m.quoted ? m.quoted : m
  ...
  if (/webp/g.test(b__c)) d__c = await webp2png(c__c)
        ...
        let ee = 'https://wudysoft.up.railway.app/api/maker/' + args[0] + '?url=' + d__c + '&apikey=Lann'
...
case 'streetsign':
case 'waterwriting':
        let ff = 'https://wudysoft.up.railway.app/api/photofunia/' + args[0] + '?text=' + one + '&apikey=Lann'
...
let a__b = m.quoted ? m.quoted : m
  ...
  if (/webp/g.test(b__b)) d__b = await webp2png(c__b)
        ...
        let gg = 'https://wudysoft.up.railway.app/api/photofunia/' + args[0] + '?url=' + d__b + '&apikey=Lann'
...
let a__a = m.quoted ? m.quoted : m
  ...
  if (/webp/g.test(b__a)) d__a = await webp2png(c__a)
        ...
        let hh = 'https://wudysoft.up.railway.app/api/photooxy/' + args[0] + '?url=' + d__a + '&apikey=Lann'
...
case 'shadow':
case 'smoke':
        let ii = 'https://wudysoft.up.railway.app/api/photooxy/' + args[0] + '?text=' + one + '&apikey=Lann'
...
case 'transformer':
case 'videogame':
        let jj = 'https://wudysoft.up.railway.app/api/textpro/' + args[0] + '?text=' + one + '&apikey=Lann'
